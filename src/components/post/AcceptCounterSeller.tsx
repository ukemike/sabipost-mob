...
import { useAcceptCounterNegotiationSellerMutation } from "../../redux/services/quotes.service";
import { useToast } from "react-native-toast-notifications";
import { useAppSelector } from "../../redux/store";

const AcceptCounterSeller = ({
  item,
  post,
  onClose,
  navigation,
  ...
  const [acceptCounterNegotiationSeller, { isLoading }] =
    useAcceptCounterNegotiationSellerMutation();

  const handleAccept = async () => {
    await acceptCounterNegotiationSeller({
...
export default AcceptCounterSeller;
